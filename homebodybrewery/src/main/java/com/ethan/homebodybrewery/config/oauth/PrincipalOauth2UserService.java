package com.ethan.homebodybrewery.config.oauth;

import com.ethan.homebodybrewery.config.auth.PrincipalDetails;
import com.ethan.homebodybrewery.config.oauth.provider.FacebookUserInfo;
import com.ethan.homebodybrewery.config.oauth.provider.GoogleUserInfo;
import com.ethan.homebodybrewery.config.oauth.provider.NaverUserInfo;
import com.ethan.homebodybrewery.config.oauth.provider.OAuth2UserInfo;
